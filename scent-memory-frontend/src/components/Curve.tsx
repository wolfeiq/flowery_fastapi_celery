...
export default function CurvedText() {
  const lines = [
    { text: `Your Personal`, size: 'text-[10rem]', weight: 'font-normal' },
    { text: 'Fragrance', size: 'text-[12rem]', weight: 'font-semibold' },
    { text: 'Journey', size: 'text-[16rem]', weight: 'font-normal' }
  ];
  ...
  return (
    <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen pt-[20px] flex justify-center pointer-events-none">
